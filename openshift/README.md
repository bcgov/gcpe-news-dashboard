...
All routes created by these scripts are explicitly defined for the Pathfinder (BC Government) instance of OpenShift; i.e. your app URL (in dev) is defined as https://news-dashboard-nrms-dev.pathfinder.gov.bc.ca/ instead of pointing to your local instance.
...
https://news-dashboard-nrms-dev.pathfinder.gov.bc.ca/

After:

https://news-dashboard-nrms-dev.10.0.75.2.nip.io/
